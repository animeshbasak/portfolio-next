...
const NAV_ITEMS = [
  { href: '/legacy#about', label: 'Dossier' },
  { href: '/legacy#timeline', label: 'Log' },
  { href: '/legacy#projects', label: 'Lab' },
  { href: '/legacy#skills', label: 'Stack' },
  { href: '/legacy#blog', label: 'Transmissions' },
  { href: '/legacy#contact', label: 'Signal' },
]
