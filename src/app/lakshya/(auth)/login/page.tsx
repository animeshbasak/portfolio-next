    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--lk-text-muted)', fontSize: '14px', margin: 0 }}>
            Sign in to continue
          </p>
        </div>

        <div style={{ width: '100%', height: '1px', background: 'var(--lk-border)' }} />
        ...
        <p style={{ color: 'var(--lk-text-muted)', fontSize: '12px', textAlign: 'center', margin: 0 }}>
